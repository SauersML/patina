...
SCORE = [
    ...
    (16, "I feel the searing caress of that merciless sun upon my compound eyes.",
     [("I", 0.0, 0.5, 0.8, "E4", {}),
      ...
      ("of", 5.0, 0.5, 0.7, "A4", {}),
      ("that", 5.5, 0.5, 0.7, "A4", {}),
      ("merciless", 6.0, 1.5, 0.9, [(0, "A4"), (0.4, "G4"), (0.75, "F#4")], {}),
      ("sun", 8.0, 2.0, 1.0, "B4", {"scoop": -2.0, "vib": (0.4, 5.7, 32)}),
      ("upon", 10.0, 1.0, 0.8, "E4", {}),
      ("my", 11.0, 0.5, 0.8, "D4", {}),
      ("compound", 11.5, 1.5, 1.0, [(0, "D4"), (0.5, "C#4")], {}),
      ("eyes", 13.25, 2.25, 1.0, [(0, "C#4"), (0.5, "B3")],
    ...
    (16, "Its rays refracting into kaleidoscopic fractals that shimmer "
     ...
     [("Its", 0.0, 0.5, 0.8, "E4", {}),
      ...
      ("kaleidoscopic", 5.5, 2.5, 1.0,
       [(0, "E4"), (0.25, "G4"), (0.5, "B4"), (0.75, "D5")], {}),
      ("fractals", 8.0, 1.5, 0.9, [(0, "D5"), (0.5, "B4")], {}),
    ...
    (16, "The relentless heat becomes a roar in my tendril antennae, an "
     ...
     [("The", 0.0, 0.5, 0.7, "E4", {}),
      ...
      ("a", 4.5, 0.25, 0.7, "A4", {}),
      ("roar", 4.75, 1.75, 1.0, "D5", {"scoop": -3.0, "vib": (0.4, 5.7, 34)}),
      ("in", 7.0, 0.5, 0.7, "A4", {}),
      ("my", 7.5, 0.5, 0.7, "A4", {}),
    ...
    (16, "As the burning orb reaches its zenith, I shed my outer vestments.",
     [("As", 0.0, 0.5, 0.7, "E4", {}),
      ...
      ("its", 5.0, 0.5, 0.7, "A4", {}),
      ("zenith", 5.5, 1.5, 0.9, [(0, "D5"), (0.5, "C#5")], {"scoop": -1.5}),
      ("I", 8.0, 0.5, 0.8, "E4", {}),
      ("shed", 8.5, 1.5, 1.0, "G4", {"scoop": -1.5, "vib": (0.5, 5.7, 28)}),
      ("my", 10.0, 0.5, 0.7, "F#4", {}),
      ("outer", 10.5, 1.0, 0.8, [(0, "F#4"), (0.5, "E4")], {}),
      ("vestments", 11.5, 2.0, 0.9, [(0, "D4"), (0.5, "B3")],
    ...
    (16, "Not merely garments of cloth but the entire layered husk of "
     ...
     [("Not", 0.0, 0.5, 0.8, "E4", {}),
      ...
      ("selfhood", 13.0, 1.5, 0.9, [(0, "E4"), (0.5, "D4")], {}),
      ("itself", 14.5, 1.5, 0.9, "B3", {"vib": (0.5, 5.7, 24), "fall": -1.0})]),
    (16, "Layers upon layers of accreted assumption and conditioned "
     ...
     [("Layers", 0.0, 1.0, 0.9, "G4", {}),
      ...
      ("away", 11.5, 1.0, 0.9, [(0, "A4"), (0.5, "D4")], {}),
      ("like", 12.5, 0.5, 0.7, "D4", {}),
      ("so", 13.0, 0.5, 0.7, "D4", {}),
      ("much", 13.5, 0.5, 0.7, "C#4", {}),
      ("molted", 14.0, 1.0, 0.9, [(0, "C#4"), (0.5, "B3")], {}),
      ("casing", 15.0, 1.0, 0.9, "B3", {"fall": -1.0})]),
