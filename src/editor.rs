...
impl EditorState {
        ...
        egui::CentralPanel::default()
            ...
            .show(ctx, |ui| {
                ...
                painter.line_segment(
                    [
                        pos2(rail.left(), rail.bottom()),
                        pos2(rail.right(), rail.bottom()),
                    ],
    ...
    fn panel_body(&mut self, ui: &mut egui::Ui) {
        ...
        ui.horizontal_top(|ui| {
            ui.vertical(|ui| {
                card(ui, "Oscillator", tex.as_mut(), None, |ui| {
                    ui.horizontal(|ui| {
                        ui.vertical(|ui| {
                            ui.add_space(6.0);
            ...
            ui.vertical(|ui| {
                card(ui, "Oscillator 2", tex.as_mut(), None, |ui| {
                    ui.horizontal(|ui| {
                        ui.vertical(|ui| {
                            ui.add_space(14.0);
            ...
            ui.vertical(|ui| {
                card(ui, "Oscillator 3", tex.as_mut(), None, |ui| {
                    ui.horizontal(|ui| {
                        ui.vertical(|ui| {
                            ui.add_space(14.0);
        ...
        ui.horizontal_top(|ui| {
            ui.vertical(|ui| {
                card(ui, "LFO", tex.as_mut(), None, |ui| {
                    ui.horizontal(|ui| {
            ...
            ui.vertical(|ui| {
                card(ui, "Routing", tex.as_mut(), None, |ui| {
                    ui.horizontal(|ui| {
                        ui.vertical(|ui| {
                            ui.add_space(14.0);
            ...
            ui.vertical(|ui| {
                card(ui, "Osc 1 Mixer", tex.as_mut(), None, |ui| {
                    ui.horizontal(|ui| {
            ...
            ui.vertical(|ui| {
                card(ui, "Unison", tex.as_mut(), None, |ui| {
                    ui.horizontal(|ui| {
        ...
        ui.horizontal_top(|ui| {
            ui.vertical(|ui| {
                card(ui, "Amp Envelope", tex.as_mut(), None, |ui| {
                    ui.horizontal(|ui| {
            ...
            ui.vertical(|ui| {
                card(ui, "Filter", tex.as_mut(), None, |ui| {
                    ui.horizontal(|ui| {
            ...
            ui.vertical(|ui| {
                card(ui, "Filter Envelope", tex.as_mut(), None, |ui| {
                    ui.horizontal(|ui| {
        ...
        ui.horizontal_top(|ui| {
            ...
            ui.vertical(|ui| {
                card(ui, "Chorus", tex.as_mut(), None, |ui| {
                    ui.vertical(|ui| {
                        ui.add_space(4.0);
            ...
            ui.vertical(|ui| {
                card(ui, "Tape", tex.as_mut(), None, |ui| {
                    ui.horizontal(|ui| {
        ...
        card(
            ui,
            "Rhythm Section · 909 · C-2 upward, or MIDI CH 10",
            tex.as_mut(),
            None,
            |ui| {
